...
import {
  deleteRosterUpload,
  subscribeRosterUploads,
  uploadRosterDocument,
  type RosterEntity,
} from '@/lib/roster-documents'
...
export function RosterDocumentsPanel({
  entity,
  entityId,
}: {
  entity: RosterEntity
  ...
  useEffect(() => {
    const unsub = subscribeRosterUploads(
      entity,
      entityId,
  ...
  const onPickFile: React.ChangeEventHandler<HTMLInputElement> = async (e) => {
    ...
    setUploading(true)
    try {
      await uploadRosterDocument(entity, entityId, category, file)
  ...
  const confirmDelete = async () => {
    ...
    setDeleting(true)
    try {
      await deleteRosterUpload(entity, entityId, pendingDelete)
